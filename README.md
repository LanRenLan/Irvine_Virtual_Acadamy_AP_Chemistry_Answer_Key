...
*分子之间可以存在多种IMFs，互不冲突，越多越强，而考试的时候大多数情况下只会用到LDF, Dipole-dipole, Hydrogen Bondings，其他几个只在FRQ里有小概率出现，因为其他几个都需要不同的分子之间互相作用，而AP Chem大多数情况下都是在问某个Molecule的Boiling point为什么比另一个的高，这种情况下，两种Molecule都只有自己跟自己之间的IMFs

*注意如果LDF的电子足够多，例如I2的两百多个电子，也是可以比dipole diople强的，所以强弱并不绝对。中括号里的内容是没用的冷知识，考试不需要
...
极性分子与非极性分子间的作用力称为偶极诱导偶极作用力。存在于极性分子与非极性分子之间。「极性分子具有永久的偶极，而非极性分子本身没有偶极。然而，当极性分子靠近非极性分子时，非极性分子的电子云会发生畸变，形成一个诱导偶极。」例如，极性分子HCl与非极性分子Ar之间的相互作用。 

3.Ion-induced dipole：
离子诱导偶极作用力发生在带电粒子/charged particles（或是离子/ions）与非极性分子之间。「离子的电荷会影响非极性分子的电子云分布，从而在非极性分子中诱导一个偶极。」例如，Na+离子与O2分子间的相互作用。 

4.Dipole-dipole：
偶极-偶极作用力发生在两个永久偶极分子之间。「这些作用力是由于分子间的正负电荷吸引而产生的。」例如，在HCl之间。

5.Ion-dipole：
离子-偶极作用力是带电粒子/charged particles（或是离子/ions）与极性分子之间的相互作用力。「这种相互作用在溶液中尤为重要」，例如，Na+离子与水分子（H2O）之间的相互作用。 

6.Hydrogen Bonding：
「氢键是一种特殊类型的偶极-偶极作用力，」Hrdrogen bonding考的很多，发生在具有氢原子的极性分子之间。氢键形成的条件是，氢原子与高度电负性原子（F, O，N）相连。这种作用力比其他作用力要强得多。例如，水分子（H2O）之间的氢键（H2O有两个氢键，这很容易理解，但是要知道CH3COOH（醋酸/acetic acid（弱酸））有几个氢键，就需要画出来对应的Lewis dot diagram，光看化学式是肯定看不出来的，这也是AP chem的考点之一。

----------------------------------------------------------------------------------------------------

VESPR Theory/分子3D结构 

*这部分也是必考的，键角/bond angle很有必要背一下，然后还有一个常识就是lone Pair占据的体积比Bond更大，这个差距虽然在计算键角的时候忽略不计，但是MCQ和FRQ都需要你知道“有lone pair会挤压其他bond的空间，导致键角略微小于计算的理论值”

1.线性（linear）: 在线性分子中，如DiAtomic Molecules（如O2、N2）和CO2，如果两端的原子相同，那么键偶极矩（Dipole）会抵消，导致整个分子的偶极矩为零。然而，如果两端的原子不同（如HCl），则会产生偶极矩。线性分子具有2个键，0个孤对，180°的键角。 
